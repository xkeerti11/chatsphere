...
export default function SettingsRoutePage() {
  ...
  return (
    <ProtectedShell title="Settings">
      <div className="min-h-full p-3 pb-20 sm:p-4 sm:pb-6 lg:p-6">
        <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
          <section className="mb-4 rounded-2xl bg-white p-4 sm:p-6">
          ...
          <form className="mt-6 space-y-5" onSubmit={handleProfileSubmit}>
            <div className="flex flex-col items-center gap-4 rounded-[1.5rem] bg-[var(--background-soft)] p-4 sm:flex-row sm:items-start">
              <Avatar
                name={previewName}
              ...
              <Button
                type="button"
                variant="secondary"
                className="min-h-[44px] w-full justify-center rounded-xl px-4 py-2.5 text-sm font-medium sm:w-auto sm:self-start sm:px-6"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="space-y-2">
                ...
                <Input
                  className="w-full rounded-xl border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 sm:px-4 sm:text-base"
            ...
            <div className="flex justify-end">
              <Button
                className="min-h-[44px] w-full justify-center rounded-xl px-4 py-2.5 text-sm font-medium sm:w-auto sm:px-6"
          ...
          <section className="space-y-4">
            <div className="mb-4 rounded-2xl bg-white p-4 sm:p-6">
            <div className="flex items-start gap-3">
            ...
            <div className="mb-20 rounded-2xl bg-white p-4 sm:p-6 md:mb-6">
